  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4">
        <div className="w-24 h-24 bg-gradient-to-br from-pollo-amarillo to-pollo-marron-claro rounded-xl flex items-center justify-center flex-shrink-0">
          <Gift className="w-10 h-10 text-white" />
        </div>
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-pollo-marron-oscuro text-lg">{sorteo.titulo}</h3>
      ...
      <div className="mt-4 pt-4 border-t border-pollo-marron-claro/20">
        <p className="text-xs font-semibold text-pollo-marron/60 mb-2">PREMIOS:</p>
        <div className="flex gap-2">
          {sorteo.premios.slice(0, 3).map((premio, i) => (
            <div 
              key={premio.id}
            ...
            >
              ...
              <span className="truncate max-w-[80px]">{premio.nombre}</span>
            </div>
          ))}
        </div>
      </div>
