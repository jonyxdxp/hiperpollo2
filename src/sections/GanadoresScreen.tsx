      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl border border-pollo-marron-claro/30 focus:border-pollo-amarillo focus:ring-2 focus:ring-pollo-amarillo/20 outline-none"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-pollo-marron-claro/20">
            ...
            <p className="text-2xl font-black text-pollo-marron-oscuro">{sorteosFinalizados.length}</p>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-pollo-marron-claro/20">
            ...
            <p className="text-2xl font-black text-pollo-marron-oscuro">{ganadores.length}</p>
          </div>
        </div>

        {/* Lista de sorteos finalizados */}
        <div>
          <h2 className="text-lg font-bold text-pollo-marron-oscuro mb-4">Sorteos Finalizados</h2>
              ...
              {sorteosFiltrados.map((sorteo) => {
                ...
                return (
                  <div key={sorteo.id} className="card-premium overflow-hidden">
                    ...
                    {estaExpandido && (
                      <div className="mt-4 pt-4 border-t border-pollo-marron-claro/20 space-y-3">
                        <h4 className="font-bold text-pollo-marron-oscuro text-sm mb-3">
                          🏆 Ganadores
                        </h4>
                        ...
                        {ganadoresSorteo.length === 0 ? (
                          ...
                          ganadoresSorteo.map((ganador) => (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-4">
                                <div className={`w-14 h-14 bg-gradient-to-br ${getPositionColor(ganador.puesto)} rounded-xl flex items-center justify-center shadow-lg`}>
                                ...
                                <div className="flex-1">
                                  ...
                                  <h3 className="font-bold text-pollo-marron-oscuro">
                              ...
                              <div className="mt-3 pt-3 border-t border-pollo-marron-claro/20">
                                <p className="text-xs text-pollo-marron/50 mb-1">PREMIO GANADO:</p>
                                <p className="font-bold text-pollo-marron-oscuro text-sm">{ganador.premio.nombre}</p>
