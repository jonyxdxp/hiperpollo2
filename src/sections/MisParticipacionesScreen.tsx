            ...
            misParticipaciones.map((participacion) => (
              ...
              >
                ...
                {participacion.estado === 'ganador' && (
                  <div className="mb-4 p-3 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-xl text-white text-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-pollo-marron-oscuro truncate">
                ...
                {/* Estado */}
                <div className="mt-4 pt-4 border-t border-pollo-marron-claro/20 flex items-center justify-between">
